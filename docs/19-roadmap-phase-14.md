...
| ENG-14-01 | 2026-06-16 | LOW | Engine LLM context: `available_services` chỉ liệt kê tên, không có mô tả → LLM không biết service làm gì | Phát hiện khi fix UX-14-01 | ✅ Đã fix (uncommitted) |
